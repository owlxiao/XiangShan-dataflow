...
object Instructions {
  ...
  def XPERM_N            = BitPat("b0010100??????????010?????0110011")
  def XPERM_B            = BitPat("b0010100??????????100?????0110011")
  ...
  def BCOMPRESS          = BitPat("b0000100??????????110?????0110011")
  def BDECOMPRESS        = BitPat("b0100100??????????110?????0110011")
  ...
  def REVB               = BitPat("b011010000111?????101?????0010011")
  ...
  // Dataflow Extension
  def DF_SUB             = BitPat("b?????????????????????_0000_01_010_11")
  def DF_ADD             = BitPat("b?????????????????????_0001_01_010_11")
  def DF_SLL             = BitPat("b?????????????????????_0010_01_010_11")
  def DF_SLT             = BitPat("b?????????????????????_0011_01_010_11")
  def DF_SLTU            = BitPat("b?????????????????????_0100_01_010_11")
  def DF_XOR             = BitPat("b?????????????????????_0101_01_010_11")
  def DF_SRL             = BitPat("b?????????????????????_0110_01_010_11")
  def DF_SRA             = BitPat("b?????????????????????_0111_01_010_11")
  def DF_OR              = BitPat("b?????????????????????_1000_01_010_11")
  def DF_AND             = BitPat("b?????????????????????_1001_01_010_11")
  def DF_MUL             = BitPat("b?????????????????????_1010_01_010_11")
  def DF_MULH            = BitPat("b?????????????????????_1011_01_010_11")
  def DF_MULHSU          = BitPat("b?????????????????????_1100_01_010_11")
  def DF_MULHU           = BitPat("b?????????????????????_1101_01_010_11")
  def DF_DIV             = BitPat("b?????????????????????_1110_01_010_11")
  def DF_DIVU            = BitPat("b?????????????????????_1111_01_010_11")
  def DF_LB              = BitPat("b?????????????????????_0000_00_010_11")
  def DF_LH              = BitPat("b?????????????????????_0001_00_010_11")
  def DF_LW              = BitPat("b?????????????????????_0010_00_010_11")
  def DF_LD              = BitPat("b?????????????????????_0011_00_010_11")
  def DF_LBU             = BitPat("b?????????????????????_0100_00_010_11")
  def DF_LHU             = BitPat("b?????????????????????_0101_00_010_11")
  def DF_LWU             = BitPat("b?????????????????????_0110_00_010_11")
  def DF_SB              = BitPat("b?????????????????????_1000_00_010_11")
  def DF_SH              = BitPat("b?????????????????????_1001_00_010_11")
  def DF_SW              = BitPat("b?????????????????????_1010_00_010_11")
  def DF_SD              = BitPat("b?????????????????????_1011_00_010_11")
  def DF_BRANCH          = BitPat("b?????????????????????_0000_10_110_11")
  def DF_MOV             = BitPat("b?????????????????????_0000_11_110_11")
  def DF_READ            = BitPat("b?????????????????????_0001_11_110_11")
  def DF_REM             = BitPat("b?????????????????????_0010_11_010_11")
  def DF_REMU            = BitPat("b?????????????????????_0011_11_010_11")
}
